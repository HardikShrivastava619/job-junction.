import './OtherUserProjects.css'
import {Link} from 'react-router-dom'
import { SlDislike, SlLike } from 'react-icons/sl'
import { FaRegCommentDots } from 'react-icons/fa'
import {  OtherUserProjectsLogic } from './OtherUserProjects.js'
...
const {hanldeprojectDisLike,  hanldeprojectLike,handleGetProject,loginData,projects,handleDeleteProject} =  OtherUserProjectsLogic();
...
</>  ) :  <div style={{ marginTop:'15vh' ,height:'75vh',display:'flex', flexDirection:'column', justifyContent:'center', gap:'5vh',  alignItems:'center' }}>
...
export default OtherUserProjects