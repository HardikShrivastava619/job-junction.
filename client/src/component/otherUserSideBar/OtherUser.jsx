  ...
  return (
    <main className="loginUser-main">
      ...
      <div className="loginUser-ul">
        <Link className="login_user-link" to={`/MoreDetails/${params?.id}`}>
          {" "}
          <div className="login-user-link-sm-box">
            {" "}
            <IoFolderOpenSharp className="loginuser-link-icons" /> User
            Profile{" "}
          </div>
        </Link>
        ...
        <Link
          className="login_user-link"
          to={`/OtherUserProjects/${params?.id}`}
        >
          {" "}
          <div className="login-user-link-sm-box">
            {" "}
            <GiGraduateCap className="loginuser-link-icons" /> Projects{" "}
          </div>
        </Link>
        <Link className="login_user-link" to={`/OtherUserPosts/${params?.id}`}>
          {" "}
          <div className="login-user-link-sm-box">
            {" "}
            <BsFileEarmarkPost className="loginuser-link-icons" /> Uploads{" "}
          </div>
        </Link>
        <div
          onClick={() => {
            {
              setFollwers(!showFollowers);
            }
          }}
          className="login_user-link"
        >
