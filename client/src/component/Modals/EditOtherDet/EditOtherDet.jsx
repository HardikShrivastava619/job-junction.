...
const EditOtherDet = ({ edit, handleMoreDetails, setEditProf, editProf }) => {
  ...
  const [official_site_url, setOfficial_site_url] = useState(
    loginData?.official_site_url,
  );
      ...
      >
        <h4>
          {edit === "dob" ? (
            ...
            "Change Your Official URL"
          ) : edit === "Chairman" ? (
            "Change Chairman's Name"
          ) : edit === "CHRO" ? (
            "Change CHRO's Name"
          ) : edit === "netWorth" ? (
            "Change Companie's Net Worth"
          ) : edit === "emp" ? (
            "Change Employaes no."
          ) : edit === "hq" ? (
            "Change Head Quarter"
        ...
        >
          {edit === "gender" ? (
            ...
            <select
              ...
              value={industry_type}
              onChange={(e) => {
                setindustry_type(e.target.value);
              }}
            >
            ...
            <select
              class="form-select editExtInput"
            ...
            <>
              <input
                type="text"
                className="form-control editExtInput"
                placeholder={city}
                onChange={() => {
            ...
            <input
              ...
              onChange={(e) => {
                ...
                else if (edit === "Official URL")
                  setOfficial_site_url(e.target.value);
