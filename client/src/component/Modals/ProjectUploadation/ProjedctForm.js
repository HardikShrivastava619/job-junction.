...
return {handleRemovePic, handleUpload,setdescription,photoPreview,url , setURL , setPhotoPreview,title , setTitle,  tech,startDate,setStartDate,endDate,setEndDate ,description,photo,setPhoto,commentsOn,setCommentsOn }
