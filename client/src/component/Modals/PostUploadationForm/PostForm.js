...
photo.forEach((file) => {
  postData.append('photo_uploads', file);
            ...
            const res = await fetch(`${import.meta.env.VITE_API_URL}/api/post/savePost/${loginData?.id}`,{
                method:"POST",
                body :postData
            }  )
...
return {handleRemovePic, handleUpload,setdescription,photoPreview , setPhotoPreview,description,photo,setPhoto,commentsOn,setCommentsOn }
