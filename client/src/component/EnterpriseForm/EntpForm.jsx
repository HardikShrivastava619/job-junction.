        ...
        if (inputNum <= 20) {
          ...
          if (inputNum === 9) {
            if (!license_doc_url) {
              setLoad(false);
              return alert(
                "Please Upload License of your Enterprise we do not allow unAuthorised Enterprises ",
              );
            }
          }
        ...
        confirmAlert({
          customUI: ({ onClose }) => (
            <div className="confirm-alert-cont">
              <p>
                {" "}
                Great You are only one step behind of registeration just give
  ...
  return (
    <form className="entForm">
      {box1 === true ? (
          ...
          {inputNum === 1 ? (
            <div class="reg-input">
              ...
              <div id="emailHelp" class="form-text">
                {" "}
                eg-Tata Consultancy , Reliance , HCL , HAL{" "}
              </div>
            </div>
          ) : inputNum === 3 ? (
            <div class="reg-input">
            ...
            <div class="reg-input">
              ...
              >
                ...
                <optgroup label="Quinary Sector">
                  ...
                  <option value="international_orgs">
                    International Organizations
                  </option>
                  <option value="think_tanks">
            ...
            <div class="reg-input">
              ...
              <div class="form-text">
                {" "}
                Upload File in - pdf , jpeg , png , jpg{" "}
              </div>
            </div>
          ) : inputNum === 11 ? (
            <div class="form-floating textarea-cont ">
              ...
              <div id="emailHelp" class="form-text ">
                {" "}
                Help others learn about your company—include your mission,
                services, or team{" "}
              </div>
            </div>
          ) : inputNum === 13 ? (
            ...
            <div className="reg-input">
              ...
              <div id="companyOwnerHelp" class="form-text">
                Enter the full legal name of the individual who owns or holds
        ...
        <div className="office-cont">
          {inputNum === 2 ? (
            ...
            <IoLocation className="ImOffice" />
          ) : inputNum === 6 ? (
            <FaUsers className="ImOffice" />
          ) : inputNum === 8 ? (
            <BsCurrencyDollar className="ImOffice" />
          ) : inputNum === 10 ? (
            <VscVerifiedFilled className="ImOffice" />
          ) : inputNum === 12 ? (
            <HiLink className="ImOffice" />
          ) : inputNum === 14 ? (
            imgPreview ? (
              <img src={imgPreview} alt="err" className="userprofpic" />
            ) : (
              <FaImage className="ImOffice" />
            )
          ) : inputNum === 16 ? (
            ...
            <BsFillPersonLinesFill className="ImOffice chro-icon" />
          ) : (
            <> </>
          )}
      ...
      {!box1 ? (
        <div className="box2">
          {inputNum === 2 ? (
            ...
            <div className="reg-input">
              ...
              <div id="emailHelp" class="form-text">
                {" "}
                eg-NewYork , Paris , Londan , Mumbai{" "}
              </div>
            </div>
          ) : inputNum === 6 ? (
            <div className="reg-input">
            ...
            <div className="reg-input">
              ...
              />
              <div id="emailHelp" class="form-text">
                Enter your estimated net worth in million USD. Example: 50 = $50
                million.
              </div>
            </div>
          ) : inputNum === 10 ? (
            <div class="form-check ent-reg-radio form-switch">
              <label
                class="form-check-label ent-reg-lable "
                for="checkNativeSwitch"
              >
                License verified
              </label>
              <input
                class="form-check-input ent-reg-radio-input "
                type="checkbox"
                checked={license_verified}
                onChange={(e) => setlicense_verified(e.target.checked)}
                value=""
            ...
            <div className="reg-input">
              ...
              <div id="emailHelp" class="form-text">
                {" "}
                Enter the full URL of your company's official website (e.g.,
            ...
            <div class="reg-input">
              <input
                ...
                onChange={(e) => {
                  ...
                  if (file) {
                    (setImg(file), setImgPreview(URL.createObjectURL(file)));
                  }
                }}
              />
              <div class="form-text">
            ...
            <div className="reg-input">
              ...
              />
              <div id="emailHelp" class="form-text">
                Enter your company’s official email address (e.g.,
            ...
            <div className="reg-input">
              ...
              <input
                ...
                value={chro}
                onChange={(e) => {
                  setChro(e.target.value);
                }}
              />
              <div id="chroHelp" class="form-text">
                Enter the full name of the Chief Human Resources Officer
                responsible for HR strategy and organizational culture.
              </div>
            </div>
          ) : (
            <></>
        ...
        <div className="office-cont">
          {inputNum === 1 ? (
            <PiBuildingOfficeDuotone className="ImOffice" />
          ) : inputNum === 3 ? (
            <BsFillCalendarDateFill className="ImOffice" />
          ) : inputNum === 5 ? (
            <FaCodeBranch className="fabranch ImOffice" />
          ) : inputNum === 7 ? (
            <FaIndustry className="ImOffice" />
          ) : inputNum === 9 ? (
            licensePreview ? (
              <img src={licensePreview} alt="err" className="userprofpic" />
            ) : (
              <TbLicense className="ImOffice" />
            )
          ) : inputNum === 11 ? (
            <ImParagraphRight className="ImOffice" />
          ) : inputNum === 13 ? (
            logoPreview ? (
              <img src={logoPreview} alt="err" className="userprofpic" />
            ) : (
              <IoLogoAndroid className="ImOffice" />
            )
          ) : inputNum === 15 ? (
